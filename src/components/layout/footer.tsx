      ...
      <div className="relative z-10 flex flex-col">
        ...
        <div className="grid grid-cols-1 gap-y-12 gap-x-6 px-6 py-16 sm:grid-cols-2 md:px-12 lg:grid-cols-5">
          ...
          <div className="flex flex-col gap-4">
            <h2
              className={`${montserrat.className} text-sm font-semibold uppercase tracking-widest ${headingColor}`}
            >
              Company
            </h2>
            <nav className="flex flex-col gap-3 text-xs sm:text-sm">
              <a href="#home" className={`transition ${textColor}`}>
                Home
              </a>
              <a href="#contact" className={`transition ${textColor}`}>
                Contact Us
              </a>
              <a href="#about" className={`transition ${textColor}`}>
                About
              </a>
            </nav>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <nav className="flex flex-col gap-3 text-xs sm:text-sm">
              <a href="#" className={`transition ${textColor}`}>
                Architecture
              </a>
              <a href="#" className={`transition ${textColor}`}>
                Urban Planning
          ...
          <div className="flex flex-col gap-4">
            ...
            <nav className="flex flex-col gap-3 text-xs sm:text-sm">
              <a href="#blogs" className={`transition ${textColor}`}>
                Blogs
              </a>
              <a href="#story" className={`transition ${textColor}`}>
                Story
              </a>
            </nav>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div
              className={`flex gap-5 ${themeTransition} ${isDark ? "text-gray-400" : "text-gray-500"}`}
            >
              <a
                href="#"
                aria-label="Twitter"
        ...
        >
          <div className="flex flex-col-reverse gap-8 md:flex-row md:items-center md:justify-between">
            <div
              className={`flex items-center justify-center md:justify-start gap-2 text-[10px] uppercase tracking-widest ${themeTransition} ${isDark ? "text-gray-500" : "text-gray-400"}`}
            >
            ...
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 md:justify-end">
              <a
                href="#"
                className={`${montserrat.className} uppercase text-[10px] tracking-wider transition ${textColor}`}
              >
                Terms
              </a>
              <a
